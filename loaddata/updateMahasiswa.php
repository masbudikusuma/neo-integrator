<?php
          ...
          <th>No</th><th>Nama</th><th>NIM</th><th>Program Studi</th>
          <th>Update</th><th>Data</th><th>Error</th><th>Description</th></tr>";
          ...
          if(mysqli_num_rows($hasil) > 0 ){
                    ...
                    echo "</td><td><pre>" . $x['nim'];echo "</td><td><pre>" . $x['program_studi'];
                    echo "</td><td><pre>" . $x['method'];echo "</td><td><pre>" . $x['data'];
                    echo "</td><td><pre>" . $x['err_no'];echo "</td><td><pre><code>" . $x['err_desc'] . "</code></td></tr>";
                    }
          } else {
