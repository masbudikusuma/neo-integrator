<?php
          ...
          <th>No</th><th>Program Studi</th><th>Kode MK</th><th>Nama Mata Kuliah</th>
          <th>semester</th><th>ID Kurikulum</th><th>Error</th><th>Description</th></tr>";
          ...
          if(mysqli_num_rows($hasil) > 0 ){
                    ...
                    echo "<tr><td>" . $no++;
                    echo "</td><td><pre>" . $x['namaprodi'];echo "</td><td><pre>" . $x['kodemk'];
                    echo "</td><td><pre>" . $x['namamk'];
                    echo "</td><td><pre>" . $x['semester'];echo "</td><td><pre>" . $x['id_kurikulum'];
