<?php
          ...
          <th>No</th><th>Nama Program Studi</th><th>Kode MK</th><th>Nama Mata Kuliah</th><th>Nama Kelas</th>
          <th>Semester</th><th>Error</th><th>Description</th></tr>";
          ...
          if(mysqli_num_rows($hasil) > 0 ){
                    ...
                    echo "<tr><td>" . $no++;
                    echo "</td><td><pre>" . $x['nama_prodi'];echo "</td><td><pre>" . $x['id_semester'];
                    echo "</td><td>" . $x['namamk'];
                    echo "</td><td><pre>" . $x['nama_kelas_kuliah'];echo "</td><td><pre>" . $x['id_semester'];
