...
$methodfeed = "GetProdi";
$exec = "getAllProdi";
$countneofeedermethod = "GetCountPerguruanTinggi";
    ...
    <div class="col-12 col-lg-12">
                    ...
                    <section class="section">
                        <div class="card">
                            ...
                            Data PT NEO FEEDER <span class="badge bg-transparent"><?php echo $neofeeder;?></span>
                            </button>
...
if(mysqli_num_rows($hasil) > 0 ){
    ...
    while($x = mysqli_fetch_array($hasil)){
        $no++;
        $nama_perguruan_tinggi = $x['nama_perguruan_tinggi'];
        ...
        echo '<tr><td><b><pre>'.$no.'</b></td><td><pre>'.$nama_perguruan_tinggi.'</td><td><pre>'.$id_perguruan_tinggi.'</td><td><pre>'.$nama_program_studi.'</td>
