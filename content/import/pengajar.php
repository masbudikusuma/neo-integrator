<?php 
// $module="Akmimport";
$ModuleName = "Pengajar Kelas Kuliah";
$table = "insertpengajarkelas";
...
<!----------------- OPSI TEXT ------------------------------->
                                ...
                                <div class="buttons justify-content-center">    
                                    ...
                                    <td><dd class="text-sm word-wrap">Kode / ID Prodi</dd><br><a href='?module=feedprodi' target="_blank" >Kode Prodi</a></td>
        ...
        if (isset($baris[2])){
            $no++;
                ...
                // $idwajib = $baris[7];
                        ...
                        // Get Program studi
                        $query = "SELECT * from getprodi where kode_program_studi='$prodi' or id_prodi='$prodi'";
                        $hasil = mysqli_query($db, $query);
                        if(mysqli_num_rows($hasil) > 0 ){
                        while($x = mysqli_fetch_array($hasil)){
